        ...
        <article class="dash_login_left_box">
            ...
            <form name="login" action="{{ route('admin.login.do') }}" method="post" autocomplete="off">
                <label>
                    ...
                    <input type="email" name="email" placeholder="Informe seu e-mail" required value="richardsonbrc@gmail.com"/>
                </label>

                <label>
                    <span class="field icon-unlock-alt">Senha:</span>
                    <input type="password" name="password_check" placeholder="Informe sua senha" value=""/>
                </label>
            ...
            <footer>
                <p>Desenvolvido por <a href="https://www.google.com.br">www.<b>google</b>.com.br</a></p>
